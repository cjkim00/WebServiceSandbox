...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButton = (Button) findViewById(R.id.buttonHelloStatus);
        ...
        mButton = findViewById(R.id.buttonHelloGet);
        mButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                buttonClick(v);
        ...
        mButton = findViewById(R.id.buttonHelloPost);
        mButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                buttonClick(v);
        ...
        mButton = findViewById(R.id.buttonHelloActions);
        mButton.setOnClickListener(this::handleHelloActionsButton);
        ...
        switch (view.getId()) {
            ...
            case R.id.buttonHelloGet:
                ...
                task.execute(getString(R.string.ep_base_url),
                        ...
                        message);
                //(R.id.inputEditText).setText("test");
                break;
